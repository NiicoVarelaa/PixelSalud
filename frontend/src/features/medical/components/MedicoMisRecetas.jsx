                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="font-bold text-gray-800 text-sm">
                          {receta.nombreCliente} {receta.apellidoCliente}
                        </div>
                        <div className="text-xs text-gray-500">
                          DNI: {receta.dniCliente}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold border ${estadoConfig.color}`}
                        >
                      ...
                      <td className="px-6 py-4 text-center">
                        ...
                        {esActiva && !fueUsada ? (
                          <button
                            onClick={() => handleAnular(receta.idReceta)}
