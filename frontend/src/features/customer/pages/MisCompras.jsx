      ...
      {ventasAgrupadas.length === 0 ? (
        ...
        <div className="flex flex-col gap-4">
          {ventasAgrupadas.map((venta) => {
            ...
            const fecha = new Date(venta.fechaPago).toLocaleDateString(
              "es-AR",
              {
                day: "numeric",
                month: "long",
            ...
            return (
              ...
              >
                <div
                  onClick={() =>
                    setExpandedOrder(isExpanded ? null : venta.idVentaO)
                  }
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-3 rounded-xl hidden sm:flex ${isExpanded ? "bg-primary-50 text-primary-600" : "bg-slate-50 text-slate-400"}`}
                      >
                        <Package size={24} />
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-bold border uppercase tracking-wider ${status.className}`}
                          >
                            {status.icon}
                            {status.label}
                          </span>
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-6 pl-14 md:pl-0">
                      ...
                      <div
                        className={`p-2 rounded-full transition-all duration-300 ${isExpanded ? "bg-primary-600 text-white rotate-180" : "bg-slate-100 text-slate-500 hover:bg-slate-200"}`}
                      >
                        <ChevronDown size={20} />
                      </div>
                    </div>
