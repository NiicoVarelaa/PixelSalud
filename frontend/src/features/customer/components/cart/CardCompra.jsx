...
const CardCompra = ({ onPurchaseCompleted }) => {
  ...
  const handleSuccess = () => {
    Swal.fire({
      ...
      customClass: {
        confirmButton:
          "px-6 py-2 mr-1 bg-white font-medium text-primary-700 hover:bg-primary-100 transition-all rounded-lg cursor-pointer border border-primary-700 shadow-sm hover:shadow-md border-2",
        cancelButton:
          "px-6 py-2 ml-1 font-medium bg-primary-700 text-white hover:bg-primary-800 transition-all rounded-lg cursor-pointer border border-primary-700 shadow-sm hover:shadow-md",
      },
  ...
  const handleCheckout = () => {
    if (!selectedPayment) {
      Swal.fire({
        ...
        customClass: {
          confirmButton:
            "px-6 py-2 font-medium bg-primary-700 text-white hover:bg-primary-800 transition-all rounded-lg cursor-pointer border border-primary-700 shadow-sm hover:shadow-md",
        },
        buttonsStyling: false,
      });
      return;
    ...
    <>
      <div className="bg-white rounded-xl shadow-sm overflow-hidden p-4">
        ...
        <div className="mb-6">
          ...
          >
            <span className="cursor-pointer hover:text-primary-700">
              Métodos de pago
            </span>
            {showPaymentMethods ? (
