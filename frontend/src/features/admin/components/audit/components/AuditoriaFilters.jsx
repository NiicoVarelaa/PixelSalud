  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-2.5 p-3 sm:grid-cols-2 lg:grid-cols-4 lg:p-3.5">
        {/* Módulo */}
        <div>
          <label htmlFor="filtro-modulo" className="mb-1.5 block text-xs font-medium text-gray-500">
            Módulo
          </label>
          <select
            id="filtro-modulo"
        ...
        {/* Tipo de usuario */}
        <div>
          <label htmlFor="filtro-usuario" className="mb-1.5 block text-xs font-medium text-gray-500">
            Tipo de usuario
          </label>
          <select
            id="filtro-usuario"
        ...
        {/* Desde */}
        <div>
          <label htmlFor="filtro-desde" className="mb-1.5 block text-xs font-medium text-gray-500">
            Desde
          </label>
          <input
            id="filtro-desde"
        ...
        {/* Hasta */}
        <div>
          <label htmlFor="filtro-hasta" className="mb-1.5 block text-xs font-medium text-gray-500">
            Hasta
          </label>
          <input
            id="filtro-hasta"
