...
/**
 * ReportCard rediseñado:
 * - Elimina los gradientes de colores distintos por reporte
 * - Sistema verde principal / naranja acento / gris neutro
 * - Mobile-first: botones táctiles de min-h-11, texto legible en 320px
 * - a11y: aria-busy, aria-disabled, aria-label con nombre del reporte
 */
const ReportCard = memo(({ report, downloading, onDownload, onViewDetails }) => {
