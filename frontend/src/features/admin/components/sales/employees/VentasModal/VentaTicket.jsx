    ...
    <div className="w-full lg:w-[55%] shrink-0 lg:min-h-0 lg:flex lg:flex-col bg-gray-50/30">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-gray-800">Resumen del Ticket</span>
      ...
      {/* Lista de Productos (Reemplaza a la tabla para 100% Mobile-first) */}
          ...
          <ul className="space-y-2" role="list">
            {ventaForm.productos.map((item, index) => (
              ...
              >
                ...
                {/* Controles y Total (Fila inferior en mobile, derecha en desktop) */}
