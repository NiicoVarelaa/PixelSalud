    ...
    <div ref={selectRef} className="relative w-full">
      ...
      <div
        ...
        className={`
          ...
          ${
            isOpen
              ? "border-green-500 bg-white ring-4 ring-green-500/10"
              : "border-gray-200 focus:border-green-500 focus:bg-white focus:ring-4 focus:ring-green-500/10"
          }
        `}
      >
      ...
      {isOpen && (
        <ul
          ...
          role="listbox"
          aria-labelledby={`${id}-label`}
          className={`absolute z-90 w-full bg-white border border-gray-200 rounded-xl shadow-xl max-h-60 overflow-y-auto py-1.5 focus:outline-none ${
            menuPlacement === "top"
