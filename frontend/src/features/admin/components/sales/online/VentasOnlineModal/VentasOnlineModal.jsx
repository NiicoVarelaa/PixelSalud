...
export const VentasOnlineModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="modal-title-online"
    >
      <div className="bg-gray-50 w-full h-[92dvh] max-h-[92dvh] rounded-t-3xl sm:rounded-2xl sm:w-full sm:max-w-7xl sm:h-[90vh] flex flex-col shadow-2xl animate-slideUp sm:animate-fadeIn overflow-hidden">
