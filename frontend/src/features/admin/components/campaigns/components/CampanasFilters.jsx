      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full h-10 pl-9 pr-9 rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:outline-none focus:bg-white focus:border-green-500 focus:ring focus:ring-green-500"
          ...
          {[
            ...
            return (
              <button
                ...
                className={`h-9 rounded-md px-3 text-xs font-semibold transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 ${
                  active
        ...
        >
          <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-md transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 ${
              vistaMode === "cards"
