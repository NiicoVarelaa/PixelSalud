...
const PRE_TEXT = "Hola, me gustaría recibir asesoramiento sobre un producto de la farmacia."; 

const WhatsAppButton = () => {
    if (!WHATSAPP_NUMBER) {
        console.error("ERROR: VITE_WHATSAPP_NUMBER no está configurado en el .env. Revisar la configuración de Vite.");
        return null; 
    }
