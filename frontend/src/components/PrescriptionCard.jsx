...
const PrescriptionCard = () => (
  <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-2xl shadow-lg overflow-hidden md:col-span-2 flex flex-col lg:flex-row transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 group">
    <div className="flex items-center justify-center p-6 lg:w-2/5 bg-gradient-to-br from-secondary-600 to-secondary-700 relative overflow-hidden">
    ...
    <div className="p-6 md:p-8 flex-1 flex flex-col justify-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 text-white font-bold py-2.5 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 cursor-pointer bg-gradient-to-r from-secondary-600 to-secondary-700 hover:from-secondary-700 hover:to-secondary-800 shadow-lg hover:shadow-xl"
        >
