...
import { Package, Users, Briefcase, DollarSign, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-8">
      ...
      <div className="text-center mb-16 animate-fadeIn">
        ...
        <p className="text-gray-500 text-lg">Bienvenido, selecciona un módulo para comenzar.</p>
      </div>

      {/* Grid de Tarjetas */}
      <nav className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
        {modulos.map((item, index) => (
          ...
          >
            {/* Círculo del icono */}
            <div className={`p-5 rounded-full mb-6 ${item.colorBg} group-hover:scale-110 transition-transform duration-300`}>
              {item.icono}
            </div>
