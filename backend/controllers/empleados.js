...
const createEmpleado = (req, res) => {
  ...
  const consulta =
    "insert into empleados (nombreEmpleado, emailEmpleado, contraEmpleado, rol) values (?,?,?,?);";

  conection.query(
    consulta,
    [nombreEmpleado, emailEmpleado, contraEmpleado, rol],
    (err, result) => {
      if (err) {
...
const updateEmpleado = (req, res) => {
  ...
  const consulta =
    "update empleados set nombreEmpleado=?, emailEmpleado=?, contraEmpleado=?, rol=? where idEmpleado=?";

  conection.query(
    consulta,
    [nombreEmpleado, emailEmpleado, contraEmpleado, rol, idEmpleado],
    (err, results) => {
      if (err) {
