...
class EmpleadosService {
   ...
   * @returns {Promise<Object>}
   */
  async crearEmpleado(empleadoData, permisos) {
   ...
   */
  async actualizarEmpleado(idEmpleado, empleadoData, permisos) {
   ...
   * @returns {Promise<void>}
   */
  async darBajaEmpleado(idEmpleado) {
    const empleado = await empleadosRepository.findByIdWithPermisos(idEmpleado);
   ...
   * @returns {Promise<void>}
   */
  async reactivarEmpleado(idEmpleado) {
    const empleado = await empleadosRepository.findByIdWithPermisos(idEmpleado);
